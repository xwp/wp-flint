...
/**
 * Plugin Name: Flint
 * Plugin URI: https://github.com/xwp/wp-flint
 * Description: Create, discover, and join projects.
 * Version: 0.1
 * Author:  XWP
...
if ( version_compare( phpversion(), '5.3', '>=' ) ) {
	...
	if ( defined( 'WP_CLI' ) ) {
		WP_CLI::warning( _flint_php_version_text() );
	} else {
		add_action( 'admin_notices', '_flint_php_version_error' );
	}
}
 ...
 */
function _flint_php_version_error() {
	printf( '<div class="error"><p>%s</p></div>', esc_html( _flint_php_version_text() ) );
}
